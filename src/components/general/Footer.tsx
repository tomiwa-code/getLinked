const Footer = () => {
  return (
    <div className="  px-40 pt-20 pb-10 bg-[#100B20] space-y-12">
      {/* column 1 */}
      <div className="flex justify-between items-center">
        <div>
          ...
          <div className=" text-white text-[12px] font-normal mt-2">
          ...
          <div className=" mt-20">
            <span className=" text-white text-[12px] font-normal">
              Terms of Use{" "}
              <span className=" border-r-2 border-pinnk px-1  mr-2"></span>
              Privacy Policy
            </span>
          </div>
        </div>
        ...
        <div className=" w-[200px]">
          <div className=" text-pinnk text-[14px] font-semibold pt-5">
            Useful Links
          </div>
          <div className=" text-white text-[12px] font-normal mt-3 cursor-pointer">
            Overview
          </div>
          <div className=" text-white text-[12px] font-normal mt-3 cursor-pointer">
            Timeline
          ...
          <div className=" flex mt-10">
            <span className=" text-pinnk text-[12px] font-normal mr-4 pt-2">
              Follow us
            </span>
        ...
        <div>
          <div className=" w-[250px]">
            ...
            <div className=" flex mt-5">
              ...
              <div className=" ml-5 text-white font-normal text-[12px]">
                +234 6707653444
              </div>
            </div>
            <div className=" flex mt-5">
